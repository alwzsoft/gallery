(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))i(o);new MutationObserver(o=>{for(const n of o)if(n.type==="childList")for(const r of n.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&i(r)}).observe(document,{childList:!0,subtree:!0});function t(o){const n={};return o.integrity&&(n.integrity=o.integrity),o.referrerPolicy&&(n.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?n.credentials="include":o.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function i(o){if(o.ep)return;o.ep=!0;const n=t(o);fetch(o.href,n)}})();async function l(){try{const s=await fetch("data/pictures.json");if(!s.ok)throw new Error("Failed to load pictures data");return await s.json()}catch(s){return console.error("Error loading pictures:",s),[]}}function d(s){const e=[...s];for(let t=e.length-1;t>0;t--){const i=Math.floor(Math.random()*(t+1));[e[t],e[i]]=[e[i],e[t]]}return e}function a(s,e="desc"){return[...s].sort((t,i)=>{const o=t.date?t.date.replace(/\D/g,""):"0",n=i.date?i.date.replace(/\D/g,""):"0";return e==="desc"?n-o:o-n})}function c(s){return a(s,"desc")[0]}function m(s){const e=new Set;return s.forEach(t=>{t.tags&&t.tags.forEach(i=>e.add(i))}),Array.from(e).sort()}function u(){const s=document.getElementById("hamburger-btn"),e=document.getElementById("mobile-nav");s&&e&&(s.classList.toggle("is-active"),e.classList.toggle("is-active"),document.body.classList.toggle("nav-open"))}function p(){const s=document.getElementById("hamburger-btn"),e=document.getElementById("mobile-nav");s&&e&&(s.classList.remove("is-active"),e.classList.remove("is-active"),document.body.classList.remove("nav-open"))}function h(){const s=document.createElement("header");s.innerHTML=`
    ...
    `;const t=e.querySelector("#featured-post"),i=f(s);return t.parentNode.replaceChild(i,t),e}class y{constructor(){this.pictures=[],this.currentSection="home",this.init()}async init(){try{this.pictures=await l(),this.setupUI(),this.setupEventListeners(),this.setupScrollProgress(),this.showSection("today")}catch(e){console.error("앱 초기화 실패:",e),this.showError("데이터를 불러오는데 실패했습니다.")}}setupUI(){document.body.innerHTML=`
            <div class="phone-container">
                ...
                <section id="home" class="content-section active">
                    <div class="intro-box" style="text-align: center; padding: 60px 20px;">
                        <h2 style="font-weight: 300; font-size: 1.4rem; letter-spacing: 0.1rem; margin-bottom: 15px; color: #1a1a1a;">
                            Collect Moments,<br>Archive Yours.
                        </h2>
                        
                        <p style="font-size: 0.9rem; color: #888; letter-spacing: -0.02rem;">
                            <i class="fas fa-quote-left" style="font-size: 0.7rem; vertical-align: middle; margin-right: 5px; opacity: 0.5;"></i>
                            순간을 모아 기록이 되다
                            <i class="fas fa-quote-right" style="font-size: 0.7rem; vertical-align: middle; margin-left: 5px; opacity: 0.5;"></i>
                        </p>
                    </div>
                </section>
                ...
                <section id="about" class="content-section" style="padding: 80px 15px; background-color: #fcfcfc;">
                    <div style="max-width: 100%; margin: 0 auto; text-align: center;">
                        
                        <div style="margin-bottom: 30px;">
                            <div class="stamp" style="margin: 0 auto 15px;">
                                <span class="char-mo">모</span><span class="char-a">아</span>
                            </div>
                            <h2 style="font-family: 'serif'; font-weight: 300; font-size: 0.75rem; letter-spacing: 0.3rem; color: #999; text-transform: uppercase; margin-top: 10px;">
                                Moments of Archive
                            </h2>
                        </div>

                        <div style="line-height: 1.8; color: #444; font-family: 'Pretendard', sans-serif;">
                            
                            <div style="margin-bottom: 35px; padding: 0 10px;">
                                <p style="font-size: 1.15rem; color: #222; font-weight: 600; margin-bottom: 6px; word-break: keep-all;">
                                    맑은 시선으로 세상을 담는 기록의 공간
                                </p>
                                <p style="font-size: 0.85rem; color: #888; font-style: italic; font-family: 'serif';">
                                    An archive capturing the world<br>through a clear lens.
                                </p>
                            </div>

                            <div style="font-size: 0.9rem; color: #555; padding: 0 5px;">
                                <p style="margin-bottom: 20px; word-break: keep-all;">
                                    우리는 스쳐 지나가는 무수한 찰나 속에서<br>
                                    변하지 않는 가치를 발견하고 기록합니다.<br>
                                    MOA는 일상에 영감이 머무는 공간을 지향합니다.
                                </p>
                                <p style="font-size: 0.8rem; color: #777; line-height: 1.6; letter-spacing: -0.01rem;">
                                    We discover and record timeless values<br>
                                    within life's fleeting moments.<br>
                                    MOA is a space for daily inspiration.
                                </p>
                            </div>
                        </div>

                        <div style="margin-top: 60px; padding-top: 30px; border-top: 1px solid #eee;">
                            <p style="font-size: 0.7rem; color: #aaa; margin-bottom: 10px; letter-spacing: 0.15rem; text-transform: uppercase;">
                                Contact & Collaboration
                            </p>
                            <a href="mailto:alwzsoft@gmail.com" style="text-decoration: none; color: #1a1a1a; font-size: 1rem; border-bottom: 1px solid #1a1a1a; padding-bottom: 2px;">
                                alwzsoft@gmail.com
                            </a>
                        </div>
                    </div>
